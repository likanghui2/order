...
from flights.batik.superairjet.flight_common.cart_parse import CartParser
from flights.batik.superairjet.flight_common.flight_info_parser import FlightParser
from flights.batik.superairjet.script.web_script import WebScript
...
class WebService:
    ...
    def auth_pay(self, contact_info: ContactInfoModel, add_baggage_html: str):
        data = {
            "ctl00$ctl00$mainContent$bookingMainContent$payDet": "rbPay_BCAVA",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$CreditCardType": "VI",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$txtCardHolderName": "",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$CreditCardNumber": "",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$CreditCardExpiryMonth": "MM",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$CreditCardExpiryYear": "YY",
            "ctl00$ctl00$mainContent$bookingMainContent$ucCreditCardDisplay$CVVNumber": "",
            "ctl00$ctl00$mainContent$bookingMainContent$txtPaymentReference": "",
            "ctl00$ctl00$mainContent$bookingMainContent$ContactTitle": "Mr",
            "ctl00$ctl00$mainContent$bookingMainContent$ContactFirstName": contact_info.first_name,
            "ctl00$ctl00$mainContent$bookingMainContent$ContactLastName": contact_info.last_name,
            "ctl00$ctl00$mainContent$bookingMainContent$ddlCountryCode3": f"+{contact_info.phone_code}",
            "ctl00$ctl00$mainContent$bookingMainContent$txtPhoneNumber3": contact_info.phone_number,
            "ctl00$ctl00$mainContent$bookingMainContent$ddlCountryCode1": f"+{contact_info.phone_code}",
            "ctl00$ctl00$mainContent$bookingMainContent$txtAreaCode1": "",
            "ctl00$ctl00$mainContent$bookingMainContent$txtPhoneNumber1": "",
            "ctl00$ctl00$mainContent$bookingMainContent$ddlOriNumber": "H",
            "ctl00$ctl00$mainContent$bookingMainContent$txtEmailAddress1": contact_info.email_address,
            "ctl00$ctl00$mainContent$bookingMainContent$txtEmailAddress2": contact_info.email_address,
            "ctl00$ctl00$mainContent$bookingMainContent$chkSpecialOffers": "on",
            "ctl00$ctl00$mainContent$bookingMainContent$AcceptFareConditions": "on",
            "ctl00$ctl00$mainContent$bookingMainContent$btnContinue": "Continue",
            "ctl00$ctl00$additionalContent$additionalContent$hidTokenId": ""
        }
        ...
        if pnr_element:
            try:
                cabin_class = BeautifulSoup(pay_info, 'html.parser').select_one(
                    'tr.Step4ItinRow td:nth-of-type(6)').get_text(strip=True)
                cabin_class = cabin_class.split('(')[-1].replace(')', '')
            except Exception:
                cabin_class = None
            return pnr_element.get_text(strip=True), cabin_class
        return '111111'
