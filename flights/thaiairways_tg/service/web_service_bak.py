...
from flights.thaiairways_tg.script.web_script_bak import WebScript
...
class WebService:
    ...
    def availability_www(self,
        ...
        commercial_fare_families = commercial_fare_families+["DPECONOMY","DPBUSINESS"]
        flight_list = []
    ...
    def booking(self,
        ...
        select_flight_response = self.__script.www_sell_flight(bundle.fare_key.split("^"))
        cart_id = select_flight_response["data"]["id"]
        self.__script.www_retrieve_cart(cart_id)
        self.__script.www_baggage_policies(cart_id)
        self.add_passenger_www(passengers, contact_info, cart_id)
        order_response, pnr = self.orders_www(cart_id=cart_id, passengers=passengers)
